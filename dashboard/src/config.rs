...
pub const COMMAND_TOTAL_PROJECT_USER_SCALE: &'static str = "total_project_user_scale";
pub const COMMAND_NEW_PROJECT_USER_SCALE: &'static str = "new_project_user_scale";
